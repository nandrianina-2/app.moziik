...
export function MiniPlayerBar() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-16 z-30 px-2 pb-2 md:bottom-0 md:px-4 md:pb-4">
      <div className="mx-auto max-w-[1600px] overflow-hidden rounded-2xl border border-border/60 bg-surface shadow-[0_16px_48px_-16px_rgba(0,0,0,0.28)] backdrop-blur md:rounded-[28px]">
        ...
        <div className="flex items-center gap-3 px-3 py-2.5 md:gap-4 md:px-5 md:py-4">
          ...
          >
            <SafeImage
              ...
              width={56}
              height={56}
              className="h-11 w-11 shrink-0 rounded-xl object-cover md:h-16 md:w-16"
            />
            <span className="min-w-0">
              ...
              <span className="mt-2 hidden items-center gap-1.5 md:flex">
          ...
          <div className="hidden md:flex md:items-center md:gap-5 md:px-2">
            ...
            <button
              onClick={togglePlay}
              aria-label={isPlaying ? "Pause" : "Lecture"}
              className="grid h-11 w-11 place-items-center rounded-full bg-ink text-base transition-transform hover:scale-105"
            >
        ...
        <div className="hidden items-center gap-4 px-5 pb-4 md:flex">
